 ...
 */
class EnvService implements InterfaceInjectableService
{
    /**
     ...
     */
    public function getUserIP(bool $excludeReserved = true): array
    {
        static $result = null;
    ...
    public function getRequestUrl(): string
    {
        ...
        {
            return 'https://' . $host . $this->get('REQUEST_URI');
        }
...
//         if (preg_match('#([a-z]+)/([0-9.]+) \((.*?)\)(.*)#i', $this->getUserAgent(), $m1) > 0)
//         {
//             if ('Mozilla' === $m1[1])
//             {
...
//     }
    ...
    {
        return ('XMLHttpRequest' === $this->get('HTTP_X_REQUESTED_WITH'));
    }
...
//     {
//         return (false !== strpos(strtolower($this->get('HTTP_USER_AGENT')), ' flash'));
//     }
