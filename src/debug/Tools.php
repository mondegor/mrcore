...
/*__class_static__*/ class Tools
{
     ...
     */
    public static function var2str(mixed $variable, int $number = 0, int $maxDeep = 8): string
    {
     ...
     * Возвращается  обработанный массив.
     *
     ...
     * @param      int    $maxDeep - защита от ссылок в массивах
     */
    protected static function hideData(array &$data, array $words, int $maxDeep = 8): bool
    {
    ...
    // */
    //private static function _arg(mixed $arg, int $number): string
    //{
    //    $result = EnumLiteral::LINE_DASH . $number . '. ';
    //
    //    if (null === $arg)
    //    {
    //        $result .= 'nullable';
